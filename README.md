...
- While it is out of scope on how to setup the environment, link to a preconfigured Ubuntu 12 Machine can be found here: ([LINK](https://drive.nonan23x.dev/index.php/s/mE47Mm9smDNQiqY))
